...
int minimum_distance(int distance[], bool visited[])
{
...
void dijkstra(int graph[V][V], int src)
{
    ...
    bool visited[V]; // visited[i] = true , if vertex i is included in shortest path tree or shortest distance from src to i is finalized
